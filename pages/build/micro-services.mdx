...
With the [Vastly CLI](https://www.npmjs.com/package/@vastly/cli), you can [generate](/cli/generate),
...
{" "}
<Tabs items={["npm", "yarn"]}>
  <Tab>```bash copy filename="services/[serviceName]" npm run generate ```</Tab>
  <Tab>```bash copy filename="services/[serviceName]" yarn run generate ```</Tab>
</Tabs>
...
<Tabs items={["npm", "yarn"]}>
  <Tab>```bash copy filename="services/[serviceName]" npm run dev ```</Tab>
  <Tab>```bash copy filename="services/[serviceName]" yarn run dev ```</Tab>
</Tabs>
...
- [Docker](https://docs.docker.com/get-docker/)
  <Tabs items={["npm", "yarn"]}>
    <Tab>```bash copy filename="services/[serviceName]" npm run deploy ```</Tab>
    <Tab>```bash copy filename="services/[serviceName]" yarn run deploy ```</Tab>
  </Tabs>
  <Callout>
    TIP: You can securely store your `DATABASE_URL` using the `env` command from the [Vastly
    CLI](/cli/env)!
  </Callout>
